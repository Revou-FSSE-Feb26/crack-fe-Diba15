		...
		<div className="max-w-4xl mx-auto px-6 py-12">
			...
			<div className="mb-10">
				...
				<p className="text-lg text-content-muted max-w-2xl leading-relaxed">
					Temukan jawaban atas pertanyaan seputar TruBrush — mulai dari cara
					bergabung, proses komisi, sistem escrow, hingga keamanan akun Anda.
				</p>
			...
			<div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-14">
				{quickLinks.map(({ icon: Icon, title, description, href }) => (
					...
					>
						...
						<p className="font-heading font-semibold text-content text-sm mb-1">
							{title}
						</p>
