...
const benefits = [
	{
		...
		description:
			"Bekerja dari rumah, kafe, atau co-working space favorit Anda. Tidak ada kewajiban hadir ke kantor kecuali untuk acara tim.",
	},
	{
		icon: TrendingUp,
		title: "Equity / ESOP",
		description:
			"Semua karyawan tetap mendapatkan opsi saham (ESOP). Anda turut memiliki perusahaan yang Anda bangun.",
	},
	{
		icon: HeartPulse,
		title: "Asuransi Kesehatan",
		description:
			"Cakupan BPJS Kesehatan kelas 1 ditambah asuransi swasta untuk rawat inap, rawat jalan, dan gigi.",
	},
	{
		icon: BookOpen,
		title: "Learning Budget",
		description:
			"Rp 5 juta/tahun untuk kursus, buku, konferensi, atau sertifikasi profesional pilihan Anda.",
	},
	{
		icon: Brush,
		title: "Artist Commission Allowance",
		description:
			"Kredit komisi tahunan untuk memesan karya dari artis TruBrush — supaya Anda memahami langsung pengalaman pengguna.",
	},
	{
		icon: Clock,
		title: "Jam Kerja Fleksibel",
		description:
			"Tidak ada jam kerja kaku. Kami mengukur kinerja dari hasil, bukan dari jam yang Anda duduk di depan layar.",
	},
];
		...
		<div className="max-w-4xl mx-auto px-6 py-12">
			...
			<section className="mb-16">
				...
				<p className="text-lg text-content-muted leading-relaxed max-w-2xl mb-8">
					Di TruBrush, kami sedang membangun masa depan di mana seni buatan
					tangan manusia tetap dihargai di tengah gempuran AI. Bergabunglah
					dengan tim kecil yang berdampak besar — dan jadilah bagian dari
					gerakan yang benar-benar berarti.
				</p>
			...
			<section className="mb-16">
				...
				<p className="text-content-muted mb-8 max-w-2xl">
					Tiga prinsip ini bukan sekadar poster di dinding — mereka tercermin
					dalam setiap keputusan yang kami buat sehari-hari.
				</p>
			...
			<section className="mb-16">
				...
				<p className="text-content-muted mb-10 max-w-2xl">
					Kami mencari individu yang bersemangat, proaktif, dan percaya bahwa
					seni manusia layak untuk dilindungi dan dirayakan.
				</p>
			...
			<section className="mb-16">
				...
				<p className="text-content-muted mb-8 max-w-2xl">
					Bergabung dengan TruBrush bukan sekadar soal gaji — tapi tentang
					tumbuh bersama misi yang bermakna, dengan dukungan yang Anda layak
					dapatkan.
				</p>
			...
			<section id="apply" className="scroll-mt-24">
				...
				<p className="text-content-muted mb-8 max-w-2xl">
					Kami tidak menggunakan formulir lamaran yang rumit. Cukup kirim email
					dengan informasi yang relevan — kami akan menghubungi Anda dalam 5
					hari kerja.
				</p>
								...
								detail: (
									<>
										...
										<span className="text-xs text-content-muted mt-1 block">
											Contoh:{" "}
											<em>
												[Senior Full-Stack Engineer] Andi Saputra — Lamar
												TruBrush
											</em>
										</span>
									</>
							...
							},
							{
								...
								detail: (
									<ul className="list-disc list-inside space-y-1 text-content-muted text-sm">
										<li>
											Perkenalan singkat dan motivasi bergabung dengan TruBrush
										</li>
										<li>
											Link portofolio atau profil GitHub/Dribbble/Behance
											(sesuai posisi)
										</li>
							...
							},
							{
								...
								detail: (
									<p className="text-sm text-content-muted">
										Jika profil Anda sesuai, tim kami akan mengundang untuk sesi
										wawancara (video call, 20–30 menit) diikuti tantangan
										teknis/desain singkat sesuai posisi. Total proses seleksi
