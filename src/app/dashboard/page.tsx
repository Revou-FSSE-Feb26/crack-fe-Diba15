				...
				<div className="flex items-start gap-3">
					...
					<div>
						...
						<p className="mt-1 text-sm leading-relaxed text-content-muted">
							Beranda ini sudah memisahkan menu admin dan curator. Selanjutnya
							menu non-aktif bisa dipecah menjadi halaman manage user, artwork,
							dispute, atau laporan user sesuai kebutuhan workflow.
						</p>
					</div>
				</div>
			</div>
