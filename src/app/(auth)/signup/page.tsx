...
export default function Signup() {
    const { register, handleSubmit, control, formState: { errors } } = useForm<Signup>({
        defaultValues: {
            name: "",
            email: "",
            password: "",
        ...
        <section className="flex flex-1 justify-center relative">
            ...
            <div className="flex flex-col justify-center items-center gap-4 h-screen text-primary p-12 w-full max-w-md">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 w-full max-w-xs">
                    ...
                    {/* Name */}
                    <div>
                        <label htmlFor="name" className="block text-sm font-semibold mb-1.5 text-content">Name</label>
                        <Input
                            id="name"
                            type="text"
                    ...
                    <div>
                        <label htmlFor="confirmPass" className="block text-sm font-semibold mb-1.5 text-content">Confirmation Password</label>
                        <Input
                            id="confirmPass"
                            type="password"
                            placeholder="********"
