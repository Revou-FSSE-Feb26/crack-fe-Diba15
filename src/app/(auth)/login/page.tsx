			...
			<section>
				<div className="hidden lg:flex flex-col justify-center items-center h-screen bg-primary text-white p-12">
					<h2 className="text-4xl font-bold font-outfit mb-4">
						Welcome Back to TruBrush
					</h2>
					<p className="text-lg text-center max-w-md opacity-90">
						Connect with authentic artists and discover human-made masterpieces
						in our 100% AI-free community.
					</p>
					...
					>
						...
						<div>
							<Link
								...
								className="text-sm text-content hover:text-content-muted transition-colors"
							>
								Forgot password?
							</Link>
						</div>
