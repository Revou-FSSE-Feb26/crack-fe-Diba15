...
export default function Navbar({ onMenuToggle }: NavbarProps) {
    ...
    const inputClass = "w-full min-w-md max-w-xl pl-10 pr-4 py-2.5 text-primary bg-gray-50 dark:bg-[#1D2D37] border border-gray-200 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#33658A] dark:focus:ring-[#86BBD8] focus:border-transparent outline-none transition-all"
