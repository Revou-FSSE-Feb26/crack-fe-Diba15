      ...
      <div className="space-y-4">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
          <div>
            <div className="flex flex-wrap items-center gap-2">
              <h3 className="font-heading text-lg font-semibold text-content">{artwork.title}</h3>
        ...
        <div className="grid gap-3 text-sm sm:grid-cols-2">
          ...
          <div className="text-content-muted">
            Tipe: <span className="font-medium text-content">{uploadTypeLabel[artwork.upload_type]}</span>
          </div>
          <div className="text-content-muted">
            Diunggah: <span className="font-medium text-content">{formatDate(artwork.created_at)}</span>
          </div>
          <div className="text-content-muted">
            Gambar: <span className="font-medium text-content">{artwork.images_url.length} file</span>
          </div>
        </div>
